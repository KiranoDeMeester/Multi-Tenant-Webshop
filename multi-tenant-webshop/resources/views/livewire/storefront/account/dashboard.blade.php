<div class="py-12 max-w-4xl mx-auto">
    <div class="flex items-center gap-6 mb-12">
        <div class="h-20 w-20 rounded-full bg-primary flex items-center justify-center text-white text-3xl font-black shadow-xl ring-4 ring-primary/10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Bestellingen Kaart -->
        <a href="{{ route('storefront.account.orders') }}" wire:navigate class="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 flex flex-col items-center text-center group hover:border-primary/50 hover:shadow-md transition-all duration-300">
            <div class="w-14 h-14 bg-zinc-950 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
        ...
        <!-- Profiel Kaart -->
        <a href="{{ route('storefront.account.profile') }}" wire:navigate class="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 flex flex-col items-center text-center group hover:border-primary/50 hover:shadow-md transition-all duration-300">
            <div class="w-14 h-14 bg-zinc-950 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
        ...
        <!-- Adressen Kaart -->
        <a href="{{ route('storefront.account.addresses') }}" wire:navigate class="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 flex flex-col items-center text-center group hover:border-primary/50 hover:shadow-md transition-all duration-300">
            <div class="w-14 h-14 bg-zinc-950 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
    ...
    <div class="mt-16">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-zinc-100 flex flex-col items-center justify-center py-20 text-center">
            ...
            <button class="bg-primary hover:bg-primary/95 text-white px-6 py-3 rounded-xl font-bold transition-all" onclick="window.location.href='{{ route('storefront.products.index') }}'">
                {{ __('Nu shoppen') }}
            </button>
        </div>
    </div>
