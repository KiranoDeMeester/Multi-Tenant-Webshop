            ...
            <flux:card>
                <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
                    ...
                    <div class="md:col-span-8 space-y-6">
                        ...
                        <flux:textarea wire:model="description" :label="__('Beschrijving')" rows="4" placeholder="{{ __('Vertel iets meer over dit product...') }}" />
                    </div>
                </div>
            </flux:card>

            <!-- Pricing & Stock / Variations Toggle -->
            <flux:card>
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <flux:heading size="lg">{{ __('Voorraad & Variaties') }}</flux:heading>
                        <flux:text size="sm">{{ __('Beheer standaard voorraad of voeg variaties toe (bijv. maten of kleuren).') }}</flux:text>
                    </div>
