<div class="p-6 max-w-2xl mx-auto">
    ...
    <form wire:submit="save">
        <flux:card class="space-y-6">
            <flux:input wire:model="name" :label="__('Productnaam')" placeholder="Bijv. Draadloze Koptelefoon" />
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <flux:input type="number" wire:model="stock" :label="__('Beginvoorraad')" />
            </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                ...
                <flux:button type="submit" variant="primary">{{ __('Product Opslaan') }}</flux:button>
            </div>
        </flux:card>
    </form>
</div>
